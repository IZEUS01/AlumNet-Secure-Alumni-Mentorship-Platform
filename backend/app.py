...
def create_app(config_class=None):
    ...
    csrf.exempt(auth_bp)        # JSON API — protected by SameSite=Strict cookie
    app.register_blueprint(student_bp,     url_prefix="/student")
    csrf.exempt(student_bp)     # JSON API
    app.register_blueprint(alumni_bp,      url_prefix="/alumni")
    csrf.exempt(alumni_bp)      # JSON API
    app.register_blueprint(admin_bp,       url_prefix="/admin")
    csrf.exempt(admin_bp)       # JSON API
    app.register_blueprint(mentorship_bp,  url_prefix="/mentorship")
    csrf.exempt(mentorship_bp)  # JSON API
